...
//               const SizedBox(height: 12),
//               _buildDetailRow(Icons.people, 'Attendees', '${widget.event.registries} people going'),
...
//         ),
//         const SizedBox(height: 12),
//         AttendeeAvatars(attendeeCount: widget.event.registries),
//         const SizedBox(height: 12),
//         Text(
//           '${widget.event.registries} people are going to this event',
//           style: TextStyle(
//             color: Colors.grey[600],
//             fontSize: 14,
//           ),
